...
export class DataService {
    ...
    cargarPersonas(){
        return this.httpClient.get('https://listado-personas-a8e4f-default-rtdb.firebaseio.com/datos.json');
    }

    //Guarda todo el arreglo de personas
    guardarPersonas(personas: Persona[]) {
        this.httpClient.put('https://listado-personas-a8e4f-default-rtdb.firebaseio.com/datos.json', personas)
            .subscribe(
                (response) => {
    ...
    modificarPersona(index:number, persona: Persona){
        let url: string;
        url = 'https://listado-personas-a8e4f-default-rtdb.firebaseio.com/' + '/datos/' + index + '.json';
